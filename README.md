...
* [mx-trader-bridge](https://github.com/27dream/mx-trader-bridge) - 东方财富妙想模拟炒股 AI 自动下单桥接层，BYOK 多模型决策大脑（OpenAI/DeepSeek/Moonshot/GLM/Qwen）→ 自动调用妙想 API 下单，含每日 cron 复盘 + 周日 AI 反思迭代
